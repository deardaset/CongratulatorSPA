...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest congratulatorspa.client -- --template=react`.
- Создание файла проекта (`congratulatorspa.client.esproj`).
