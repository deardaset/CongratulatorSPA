...
namespace CongratulatorSPA.Server.Interfaces.Repositories
{
    public interface IPersonRepository
    {
        ...
        public Task<(List<Person>, int totalCount)> GetAllPeopleAsync(GetPeopleOptionsRequest request);
        public Task<List<Person>> GetTodaysBirthdaysAsync(CancellationToken cancellationToken);
